...
export function estimateLambdas(homeGoals, awayGoals, homeConceded, awayConceded, leagueAvgGoals = 2.6) {
...
export function formatModelOutput(probs, h2h, elo1X2) {
  ...
  if (probs) {
    out += `\n\n🏀 POISSON (Goles esperados: Local ${probs.expectedGoals.home} - Visitante ${probs.expectedGoals.away}, Total ${probs.expectedGoals.total})`;
