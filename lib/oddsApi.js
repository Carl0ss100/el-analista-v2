...
const LEAGUE_LABELS = {
  ...
  soccer_argentina_primera_nacional: 'Primera Division',
...
export async function searchOddsApiMatch(team1, team2, apiKey) {
  if (!apiKey) return null;
  let bestMatch = null;
  let bestScore = 0;

  for (const leagueKey of SOCCER_LEAGUES) {
...
export { SOCCER_LEAGUES, BOOK_NAMES, SHARP_BOOK, VALUE_BOOKS };
